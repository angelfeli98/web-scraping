...
var scrape_it_1 = __importDefault(require("scrape-it"));
var getData = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, scrape_it_1.default('http://www.aire.cdmx.gob.mx/default.php', {
                    clima: {
            ...
            case 1:
                data = _a.sent();
                res.status(200).json({ ok: true, data: __assign({}, data.data.clima) });
                return [2 /*return*/];
        }
    });
}); };
